    ...
    <xsl:template match="/">
        ...
        <article xmlns:xlink="http://www.w3.org/1999/xlink"
            ...
            <xsl:attribute name="lang">
                <xsl:value-of select="//meta[@name = 'DC.language']/@content"/>
            </xsl:attribute>
            ...
            <admin>
                <infoarticle>
                    ...
                    <nbmot>
                        <xsl:value-of
                            select="
                                ...
                                -
                                string-length(translate(normalize-space(//body), ' ', '')) + 1"
                        />
                    </nbmot>
                    <nbfig>
                    ...
                    <nbaudio>
                        <xsl:value-of select="count(//embed)"/>
                    </nbaudio>
                    <nbvideo>
                        <xsl:value-of select="count(//embed)"/>
                    </nbvideo>
                    <nbrefbiblio>
                        <xsl:value-of select="count(//div[@class = 'references']/div)"/>
                    </nbrefbiblio>
                    <nbnote>
                        <xsl:value-of select="count(//a[@class = 'footnoteRef'])"/>
                    </nbnote>
                </infoarticle>
                ...
                <numero id="prendre via api">
                    <pub>
                        <annee>
                            <xsl:variable name="dateValue"
                                select="//meta[@name = 'DC.date']/@content"/>
                    ...
                    <pubnum>
                        <date typedate="publication">
                            <xsl:value-of select="//meta[@name = 'DC.date']/@content"/>
                        </date>
                    </pubnum>
                </numero>
                <editeur>
                ...
                <droitsauteur>
                    <xsl:value-of select="html/head/meta[@name = 'DC.rights']/@content"/>
                </droitsauteur>
            </admin>
            <liminaire>
                <grtitre>
